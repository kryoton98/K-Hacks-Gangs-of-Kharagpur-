...
import hospitalImage from "../images/hospital.jpg"; // Import the hospital image
        ...
        <div className="flex flex-col text-custom-blue space-y-8 w-3/5 p-8 bg-gray-800 shadow-lg rounded-lg transition-transform duration-10000 ease-in-out transform hover:scale-105">
          <div className="space-y-4">
            ...
            <div className="about-content text-left"> {/* Left align the content */}
              ...
              <h3 style={{ textAlign: 'center' }}>For Doctors</h3>
              <p>
              ...
              <h3 style={{ textAlign: 'center' }}>For Patients</h3>
              <p>
              ...
              <h3 style={{ textAlign: 'center' }}>For Diagnostic Centers</h3>
              <p>
              ...
              <p>
                ...
                feedback, please feel free to contact us on Phone: +91 8320874041 , Email: vitalblockcompany@gmail.com
              </p>
            </div>
          </div>
        </div>
